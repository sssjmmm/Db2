...
** platform-specific value.
** 
** - Client accounting string being set or queried. A maximum of 200
** characters can be set, although servers can truncate this to some
** platform-specific value.
** Note:
...
** |                             |          |value. For example, DB2 for   |
** |                             |          |z/OS servers support up to    |
** |                             |          |length 16. This user ID is    |
** |                             |          |for identification purposes   |
** |                             |          |only, and is not used for any |
** |                             |          |authorization.                |
** |-----------------------------|----------|------------------------------|
** |SQLE_CLIENT_INFO_ WRKSTNNAME |CHAR(255) |The workstation name for the  |
** |                             |          |client. Some servers may      |
** |                             |          |truncate the value. For       |
** |                             |          |example, DB2 for z/OS servers |
** |                             |          |support up to length 18.      |
** |-----------------------------|----------|------------------------------|
** |SQLE_CLIENT_INFO_ APPLNAME   |CHAR(255) |The application name for the  |
** |                             |          |client. Some servers may      |
** |                             |          |truncate the value. For       |
** |                             |          |example, DB2 for z/OS servers |
** |                             |          |support up to length 32.      |
** |-----------------------------|----------|------------------------------|
** |SQLE_CLIENT_INFO_PROGRAMID   |CHAR(80)  |The program identifier for    |
** |                             |          |the client. Once this element |
** |                             |          |is set, DB2 UDB for z/OS      |
** |                             |          |Version 8 associates this     |
** |                             |          |identifier with any statements|
** |                             |          |inserted into the dynamic SQL |
** |                             |          |statement cache. This element |
** |                             |          |is only supported for         |
** |                             |          |applications accessing DB2    |
** |                             |          |UDB for z/OS Version 8.       |
** |-----------------------------|----------|------------------------------|
** |SQLE_CLIENT_INFO_ ACCTSTR    |CHAR(200) |The accounting string for the |
** |                             |          |client. Some servers may      |
** |                             |          |truncate the value. For       |
** |                             |          |example, DB2 for z/OS         |
** |                             |          |servers support up to length  |
** |                             |          |200.                          |
** |-----------------------------|----------|------------------------------|
